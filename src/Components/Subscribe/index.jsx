...
const Subscribe = () => {
  return (
    <section className="w-screen bg-sky-200 py-8 h-max">
      <Container>
        <div className="flex justify-between flex-wrap gap-8 items-center">
          <form className="flex-1 min-[320px] flex gap-2 flex-col">
            <h2 className="text-[28px] text-[#050505eb] font-[600]">
              Lets stay in touch
            </h2>
            <p className="text-[16px] font-Nunito -translate-y-2 mb-4 text-[#0a0a0aeb] font-[600]">
